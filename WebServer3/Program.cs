...
internal class Program
{
    ...
    private static async Task Main(string[] args)
    {
        ...
        listener.Start();
        Console.WriteLine("Serving files from D:\\wwwroot\\ at http://localhost:8080/ TASK.RUN - ASYNC IO");
    ...
    private static async Task ProcessRequest(HttpListenerContext context)
    {
        ...
        try
        {
            ...
            {
                await SendErrorResponseAsync(response, HttpStatusCode.Forbidden, "403 Forbidden");
                return;
            }
